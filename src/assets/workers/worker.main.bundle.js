...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dexie__ = __webpack_require__(3);


addEventListener("message", function (e) {
    var message = e.data;
    var db = new __WEBPACK_IMPORTED_MODULE_1_dexie__["a" /* default */]('hellodb');
    db.version(1).stores({
    ...
    if (message.type == "CALC") {
        var retVal = Object(__WEBPACK_IMPORTED_MODULE_0__common__["a" /* calc */])(message.interval);
        var response = {
            id: message.id,
            type: "CALC_DONE",
            retVal: retVal,
